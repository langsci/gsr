...
is the relative pronoun \textit{dem} in (4) in \sectref{sec:numberedexamples} below. Full caps and
...
acknowledgements, see \sectref{sec:parts} above). Numbered examples in footnotes have the
numbers \gsrex{(i)}, 
...
Series titles have special capitalization, like journal titles (see \sectref{sec:capitalization}).\todo{chinese, paragraphs}
